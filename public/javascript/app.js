...
const firebaseConfig = {
    apiKey: "AIzaSyA7ibJvidtlHQi1ERfq5OMzqQmqcdhD6mA",
    authDomain: "aa-dashboard-37704.firebaseapp.com",
    projectId: "aa-dashboard-37704",
    storageBucket: "aa-dashboard-37704.appspot.com",
    messagingSenderId: "388744715166",
    appId: "1:388744715166:web:8fec1f7a1c7333e12ed48f"
};
...
function startDataListeners() {
    console.log('Starting data listeners')
            ...
            querySnapshot.forEach(async function (doc) {
                ...
                priceSnap.docs.forEach((doc) => {
                    ...
                    const content = document.createTextNode(
                        ...
                        }).format((priceData.unit_amount).toFixed(2))} per ${
